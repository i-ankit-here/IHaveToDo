            ...
            <div className='flex gap-1 h-dvh overflow-y-hidden'>
                ...
                <div className='mt-15'>
                    <div className='pt-3 border-b-2 border-neutral-200 mx-8'>
                        <p className={`${theme == "light" ? "" : "text-zinc-400 "}text-5xl font-semibold font-sans`}>Hello {`${user?.firstname}`} !!</p>
                    </div>
                        ...
                        {majorTodos.map((item, index) => {
                            return <div key={index} className='flex'>
                                <div
                                    ...
                                    onClick={()=>{navigate(`../todos/${majorTodos[index]._id}`)}}
                                >
                                    ...
                                    {view != index ? (<div className='w-full md:w-75 p-1 font-medium flex justify-around items-end flex-col text-center'>
                                        ...
                                        : (<div className='w-full md:w-65 justify-around items-end flex text-center'>
                                            <button type="button" className='p-1 w-24 rounded-2xl border-2 border-gray-400 bg-gray-300 hover:bg-gray-400 font-semibold' onClick={() => { e.stopPropagation();save(index) }}>Save</button>
                                            <button type="button" className='p-1 w-24 rounded-2xl border-2 border-gray-400 bg-gray-300 hover:bg-gray-400 font-semibold' onClick={()=>{ e.stopPropagation();cancel(index) }}>Cancel</button>
                                        </div>)}
                                </div>
                                {
